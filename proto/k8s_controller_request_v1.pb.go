...
type GetDeployInfomationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetDeployInfomationRequest) Reset() {
	*x = GetDeployInfomationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDeployInfomationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDeployInfomationRequest) ProtoMessage() {}

func (x *GetDeployInfomationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_k8s_controller_request_v1_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDeployInfomationRequest.ProtoReflect.Descriptor instead.
func (*GetDeployInfomationRequest) Descriptor() ([]byte, []int) {
	return file_proto_k8s_controller_request_v1_proto_rawDescGZIP(), []int{10}
}

func (x *GetDeployInfomationRequest) GetOrganization() string {
	if x != nil {
		return x.Organization
	}
	return ""
...
func (x *GetDeployInfomationRequest) GetRepository() string {
	if x != nil {
		return x.Repository
	}
	return ""
...
func (x *GetDeployInfomationRequest) GetPullRequestId() string {
	if x != nil {
		return x.PullRequestId
	}
	return ""
...
func (x *GetDeployInfomationRequest) GetBranch() string {
	if x != nil {
		return x.Branch
	}
	return ""
...
var file_proto_k8s_controller_request_v1_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x74, 0x73, 0x22, 0xa0, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x44, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x75, 0x6c, 0x6c, 0x5f,
	...
	0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proto_k8s_controller_request_v1_proto_goTypes = []interface{}{
	...
	(*GetDeployInfomationRequest)(nil), // 10: gantrycd.k8s_controller.v1.GetDeployInfomationRequest
}
...
func file_proto_k8s_controller_request_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_k8s_controller_request_v1_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDeployInfomationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
