...
type CreatePreviewReply struct {
	...
	Name      string   `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Version   string   `protobuf:"bytes,3,opt,name=version,proto3" json:"version,omitempty"`
	NodePorts []string `protobuf:"bytes,4,rep,name=node_ports,json=nodePorts,proto3" json:"node_ports,omitempty"`
}
...
func (x *CreatePreviewReply) GetNodePorts() []string {
	if x != nil {
		return x.NodePorts
	}
	return nil
...
var file_proto_k8s_controller_response_v1_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x7f, 0x0a, 0x12, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	...
	0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x6e,
	0x6f, 0x64, 0x65, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x09, 0x6e, 0x6f, 0x64, 0x65, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x27, 0x0a, 0x0f, 0x42, 0x75,
...
var file_proto_k8s_controller_response_v1_proto_goTypes = []interface{}{
	...
	(*BuildImageReply)(nil),       // 13: gantrycd.k8s_controller.v1.BuildImageReply
	(*GetLogsReply)(nil),          // 14: gantrycd.k8s_controller.v1.GetLogsReply
}
