...
const (
	...
	K8SCustomController_GetRepoBranches_FullMethodName  = "/gantrycd.k8s_controller.v1.K8sCustomController/GetRepoBranches"
	...
	K8SCustomController_BuildImage_FullMethodName       = "/gantrycd.k8s_controller.v1.K8sCustomController/BuildImage"
...
func (c *k8SCustomControllerClient) GetRepoBranches(ctx context.Context, in *GetRepoBranchesRequest, opts ...grpc.CallOption) (*GetRepoBranchesReply, error) {
	...
	err := c.cc.Invoke(ctx, K8SCustomController_GetRepoBranches_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *k8SCustomControllerClient) BuildImage(ctx context.Context, in *BuildImageRequest, opts ...grpc.CallOption) (*BuildImageReply, error) {
	...
	err := c.cc.Invoke(ctx, K8SCustomController_BuildImage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _K8SCustomController_GetRepoBranches_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: K8SCustomController_GetRepoBranches_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _K8SCustomController_BuildImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: K8SCustomController_BuildImage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
