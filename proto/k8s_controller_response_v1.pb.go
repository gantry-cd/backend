...
type GetBranchInfoReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBranchInfoReply) Reset() {
	*x = GetBranchInfoReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBranchInfoReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBranchInfoReply) ProtoMessage() {}

func (x *GetBranchInfoReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_k8s_controller_response_v1_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBranchInfoReply.ProtoReflect.Descriptor instead.
func (*GetBranchInfoReply) Descriptor() ([]byte, []int) {
	return file_proto_k8s_controller_response_v1_proto_rawDescGZIP(), []int{10}
}

func (x *GetBranchInfoReply) GetYaml() string {
	if x != nil {
		return x.Yaml
	}
	return ""
...
var file_proto_k8s_controller_response_v1_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x22, 0x28, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x79, 0x61, 0x6d,
	0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x79, 0x61, 0x6d, 0x6c, 0x22, 0x36, 0x0a,
	0x08, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x61, 0x72,
	...
	0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0xa5, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1c, 0x0a, 0x09,
	...
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x43, 0x0a, 0x0a, 0x6e, 0x6f, 0x64, 0x65,
	...
	0x72, 0x74, 0x52, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x42, 0x3c, 0x5a,
...
func file_proto_k8s_controller_response_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_k8s_controller_response_v1_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBranchInfoReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
